...
element.click()
element = browser.find_element_by_xpath('//*[@id="gist-pjax-container"]/div[1]/div/div[1]/ul/li[1]/a')
element.click()
element = browser.find_element_by_name('gist[description]')
element.send_keys('-1')
element = browser.find_element_by_xpath('//*[@id="edit_gist_102593106"]/div/div[2]/button')
element.click()
assert 'Test Shopee-1' == browser.title
browser.quit()
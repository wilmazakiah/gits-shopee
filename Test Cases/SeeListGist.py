...
element.click()
element = browser.find_element_by_xpath('//*[@id="gist-pjax-container"]/div[1]/div/div/ul/li[2]/a')
element.click()
time.sleep(5)
element = browser.find_element_by_xpath('//*[@id="gist-pjax-container"]/div/div/div[2]/div[1]/nav/a')
